...
class SurrogateProblem(Problem):
    ...
    def __init__(self, real_problem, surrogate_model, acquisition, transformation):
        ...
        xl = real_problem.xl
        xu = real_problem.xu
        super().__init__(n_var=real_problem.n_var, n_obj=real_problem.n_obj, xl=xl, xu=xu)
    ...
    def evaluate(self, *args, return_values_of="auto", **kwargs):
        ...
        o=super().evaluate(*args, return_values_of=return_values_of, calc_hessian=calc_hessian, **kwargs)
